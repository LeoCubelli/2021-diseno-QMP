...
public interface ServicioClimatico {
  ...
  public Integer temperaturaEnBsAs();

}

public class ServicioAccuWeatherAPI implements ServicioClimatico {

  AccuWeatherAPI servicioClimatico = new AccuWeatherAPI();

  Map<String, Object> climaEnBsAs() {
      return servicioClimatico.getWeather("Buenos Aires").get(0);
  }

  public Integer temperaturaEnBsAs() {
      return climaEnBsAs().get("Temperature");
  }
